...
#define UP_DAT_L 			HAL_GPIO_WritePin(GPIOB,GPIO_PIN_4,RESET)	
#define UP_DAT_H 			HAL_GPIO_WritePin(GPIOB,GPIO_PIN_4,SET)	
...
#define DRCTL_L  			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_1,RESET)  
#define DRCTL_H 			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_1,SET)  
